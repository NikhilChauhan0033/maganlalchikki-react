        ...
        <div className={style.bgBtnP}>
          <Link to="signup" style={{ textDecoration: "none", color: "black" }}>
           <button className={style.btns}>
              {" "}
              <FaLock style={{ fontSize: "10px", marginRight: "5px" }} /> Login
            </button>
          </Link>
          ...
          <div className={style.bgBtn}>
            <button className={style.english}>
              {" "}
              <img
                src={en}
                ...
                alt="img"
              />{" "}
              English <IoIosArrowDown style={{ paddingTop: "2px" }} />{" "}
            </button>
            <ul className={style.dropdownlist}>
              <li>
                <img src={en} style={{ width: "18px", marginRight: "5px" }} alt="img"/>
                English
              </li>
              <li>
                <img src={ar} style={{ width: "18px", marginRight: "5px" }} alt="img"/>
                Arabic
              </li>
            </ul>
          </div>
          <div className={style.bgBtn}>
            <button className={style.inr}>
              INR <IoIosArrowDown style={{ paddingTop: "2px" }} />{" "}
            </button>
            <ul className={style.dropdownlist}>
              <li>INR</li>
              <li>USD</li>
