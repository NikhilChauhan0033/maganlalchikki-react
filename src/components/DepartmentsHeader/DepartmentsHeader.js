      ...
      <div>
        ...
        >
          <div className={style.mdiv} style={{ padding: "0px 100px" }}>
            ...
            <a href="" className={style.adepartments}>Special Offer!</a>
          </div>
          <Navbar.Toggle
          ...
          />
          {/* Offcanvas is a Bootstrap component used to create hidden side panels that slide in from the side (left, right, top, or bottom). It is commonly used for mobile navigation menus, filters, or sidebars. */}
          ...
          <Offcanvas show={show} onHide={handleClose} placement="start">
            ...
            <Offcanvas.Body style={{ padding: "10px" }}>
              ...
              <div style={{ display: activeButton === 1 ? "block" : "none" }}>
                <MenuDepartments  onHide={handleClose}/>
              </div>

              <div style={{ display: activeButton === 2 ? "block" : "none" }}>
                <MobileHeadereMenu  onHide={handleClose}/>
              </div>
            </Offcanvas.Body>
          </Offcanvas>
        </Navbar>
