...
const WishListComponent = () => {
  ...
  // When working with localStorage, you must store data as a string. But JavaScript objects cannot be stored directly, so we use JSON.stringify() to convert them to strings and JSON.parse() to retrieve them as objects.
  useEffect(() => {
  ...
  const removeFromWishlist = (productId) => {
    ...
    // JSON.stringify() This method converts a JavaScript object/array into a JSON string.
